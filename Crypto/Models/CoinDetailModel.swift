...
/*
 ...
 
 {
   ...
   "sentiment_votes_up_percentage": 63.59,
   "sentiment_votes_down_percentage": 36.41,
   "watchlist_portfolio_users": 2409090,
   "market_cap_rank": 1,
   "market_cap_rank_with_rehypothecated": 1,
   "status_updates": [],
   "last_updated": "2026-06-27T11:01:10.740Z"
 }
 */
...
struct CoinDetailModel: Codable {
    ...
    enum CodinKeys: String, CodingKey {
        case id, symbol, name, webSlug, links, categories, description
